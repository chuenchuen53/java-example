package com.example.imperial.court.entity;
...
public class Memorials {
    ...
    public Memorials(Integer memorialsId, String memorialsTitle, String memorialsContent,
                     String memorialsContentDigest, Integer memorialsEmp, String memorialsEmpName,
