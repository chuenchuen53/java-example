package com.example.imperial.court.servlet.module;

import com.example.imperial.court.entity.Memorials;
import com.example.imperial.court.service.api.MemorialsService;
import com.example.imperial.court.service.impl.MemorialsServiceImpl;
import com.example.imperial.court.servlet.base.ModelBaseServlet;
...
public class WorkServlet extends ModelBaseServlet {
    ...
    protected void feedBack(HttpServletRequest request, HttpServletResponse response) throws ServletException,
            IOException {
        // 获取表单提交的请求参数
        String memorialsId = request.getParameter("memorialsId");
